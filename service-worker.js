...
const APP_SHELL = [
  ...
  './js/bootstrap-1.0.3.js',
  './js/app.js?v=1.0.3',
  './js/auth.js?v=1.0.3',
  './js/config.js?v=1.0.3',
  './js/db.js?v=1.0.3',
  './js/exif.js?v=1.0.3',
  './js/favorites.js?v=1.0.3',
  './js/filters.js?v=1.0.3',
  './js/gallery.js?v=1.0.3',
  './js/media.js?v=1.0.3',
  './js/permissions.js?v=1.0.3',
  './js/sites.js?v=1.0.3',
  './js/ui.js?v=1.0.3',
  './js/upload.js?v=1.0.3',
  './js/users.js?v=1.0.3',
  './js/utils.js?v=1.0.3',
  './js/viewer.js?v=1.0.3',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png',
