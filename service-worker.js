...
const APP_SHELL = [
  ...
  './js/bootstrap-1.4.1.js',
  './js/app.js?v=1.4.1',
  './js/auth.js?v=1.4.1',
  './js/config.js?v=1.4.1',
  './js/db.js?v=1.4.1',
  './js/exif.js?v=1.4.1',
  './js/file-hash.js?v=1.4.1',
  './js/filters.js?v=1.4.1',
  './js/gallery.js?v=1.4.1',
  './js/media.js?v=1.4.1',
  './js/permissions.js?v=1.4.1',
  './js/site-favorites.js?v=1.4.1',
  './js/site-picker.js?v=1.4.1',
  './js/sites.js?v=1.4.1',
  './js/ui.js?v=1.4.1',
  './js/upload.js?v=1.4.1',
  './js/users.js?v=1.4.1',
  './js/utils.js?v=1.4.1',
  './js/viewer.js?v=1.4.1',
