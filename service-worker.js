...
const APP_SHELL = [
  ...
  './js/bootstrap-1.5.0.js',
  './js/app.js?v=1.5.0',
  './js/auth.js?v=1.5.0',
  './js/config.js?v=1.5.0',
  './js/db.js?v=1.5.0',
  './js/exif.js?v=1.5.0',
  './js/file-hash.js?v=1.5.0',
  './js/filters.js?v=1.5.0',
  './js/gallery.js?v=1.5.0',
  './js/media.js?v=1.5.0',
  './js/permissions.js?v=1.5.0',
  './js/remote-auth.js?v=1.5.0',
  './js/site-favorites.js?v=1.5.0',
  './js/site-picker.js?v=1.5.0',
  './js/sites.js?v=1.5.0',
  './js/ui.js?v=1.5.0',
  './js/upload.js?v=1.5.0',
  './js/users.js?v=1.5.0',
  './js/utils.js?v=1.5.0',
  './js/viewer.js?v=1.5.0',
