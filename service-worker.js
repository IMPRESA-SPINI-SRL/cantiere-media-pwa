...
const APP_SHELL = [
  ...
  './js/bootstrap-1.4.2.js',
  './js/app.js?v=1.4.2',
  './js/auth.js?v=1.4.2',
  './js/config.js?v=1.4.2',
  './js/db.js?v=1.4.2',
  './js/exif.js?v=1.4.2',
  './js/file-hash.js?v=1.4.2',
  './js/filters.js?v=1.4.2',
  './js/gallery.js?v=1.4.2',
  './js/media.js?v=1.4.2',
  './js/permissions.js?v=1.4.2',
  './js/site-favorites.js?v=1.4.2',
  './js/site-picker.js?v=1.4.2',
  './js/sites.js?v=1.4.2',
  './js/ui.js?v=1.4.2',
  './js/upload.js?v=1.4.2',
  './js/users.js?v=1.4.2',
  './js/utils.js?v=1.4.2',
  './js/viewer.js?v=1.4.2',
