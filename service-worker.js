...
const APP_SHELL = [
  ...
  './js/bootstrap-1.0.4.js',
  './js/app.js?v=1.0.4',
  './js/auth.js?v=1.0.4',
  './js/config.js?v=1.0.4',
  './js/db.js?v=1.0.4',
  './js/exif.js?v=1.0.4',
  './js/favorites.js?v=1.0.4',
  './js/filters.js?v=1.0.4',
  './js/gallery.js?v=1.0.4',
  './js/media.js?v=1.0.4',
  './js/permissions.js?v=1.0.4',
  './js/sites.js?v=1.0.4',
  './js/ui.js?v=1.0.4',
  './js/upload.js?v=1.0.4',
  './js/users.js?v=1.0.4',
  './js/utils.js?v=1.0.4',
  './js/viewer.js?v=1.0.4',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png',
