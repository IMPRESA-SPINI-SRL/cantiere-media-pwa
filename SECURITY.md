...
Le operazioni distruttive e i preferiti non si fidano soltanto della sessione in memoria: ruolo e stato dell'utente vengono riletti dentro la transazione IndexedDB che modifica i dati. Un amministratore disattivato o retrocesso da un'altra scheda non conserva quindi privilegi distruttivi.
...
La release 1.0.3 conserva i dati su un solo dispositivo e non include sincronizzazione o backup completo. La cancellazione dei dati del sito, il ripristino del telefono o alcune politiche di storage del sistema possono rendere i file irrecuperabili.
